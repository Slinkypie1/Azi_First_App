...
public class CorrectScreen6 extends BaseMenuActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correct_screen6); // טעינת קובץ ה-XML של הפריסה
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            unlockNextLevel(6); // פתיחת השלב הבא אם יש צורך
    ...
    // שמירת זמן הסיום וטעינת טבלת המובילים עבור שלב 6
    private void saveAndLoadLeaderboard() {
        ...
        // הבאת נתוני טבלת המובילים עבור שלב 6
    ...
    private void initViews() {
        ...
        BtClick19 = findViewById(R.id.BtClick19); // קישור הכפתור מה-XML
        BtClick19.setOnClickListener(this); // הגדרת מאזין ללחיצה
