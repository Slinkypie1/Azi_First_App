...
public class CorrectScreen6 extends BaseMenuActivity implements View.OnClickListener {
    ...
    Button BtClick19;
    // Button that moves the user to Level 7

    TextView leaderboardText;
    // TextView that displays the leaderboard

    long timeTaken;
    // Stores how long the user took to complete Level 6
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockNextLevel(6);
        // Marks Level 6 as completed and unlocks Level 7 if allowed

        saveAndLoadLeaderboard();
        // Saves the player's score and loads the leaderboard
    }

    // Saves the completion time and loads the leaderboard for Level 6
    private void saveAndLoadLeaderboard() {
        ...
        if (timeTaken > 0) {
            ...
            // Saves completion time for Level 6
        }

        // Requests leaderboard data for Level 6
        ProgressStorage.getLeaderboard(6, new ProgressStorage.LeaderboardCallback() {
    ...
    private void unlockNextLevel(int currentLevel) {
        ...
        if (currentLevel == ProgressStorage.getHighestUnlockedLevel(this)) {
            // Check if Level 6 was the latest unlocked level
    ...
    public void onClick(View view) {
        ...
        // Creates an intent to start the Level 7 activity
