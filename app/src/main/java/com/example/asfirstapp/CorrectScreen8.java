...
// Screen shown when the user completes Level 8 successfully
public class CorrectScreen8 extends BaseMenuActivity implements View.OnClickListener {

    Button BtClick21; // Button that continues to Level 9
    TextView leaderboardText; // Displays leaderboard results
    long timeTaken; // Stores completion time for Level 8
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correct_screen8); // Load layout XML
        ...
        // Apply window insets and initialize UI
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {

            initViews(); // Setup UI elements
            unlockNextLevel(8); // Unlock next level if needed
    ...
    // Saves completion time and loads leaderboard for Level 8
    private void saveAndLoadLeaderboard() {
        ...
        // Fetch leaderboard data for Level 8
    ...
    private void initViews() {
        ...
        BtClick21 = findViewById(R.id.BtClick21); // connect button from XML
        BtClick21.setOnClickListener(this); // set click listener
