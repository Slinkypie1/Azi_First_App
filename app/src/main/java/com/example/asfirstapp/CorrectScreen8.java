...
public class CorrectScreen8 extends BaseMenuActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correct_screen8); // טעינת קובץ ה-XML של הפריסה
        ...
        // החלת שולי חלון ואתחול ממשק המשתמש
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {

            initViews(); // הגדרת רכיבי ממשק המשתמש
            unlockNextLevel(8); // פתיחת השלב הבא אם יש צורך
    ...
    // שמירת זמן הסיום וטעינת טבלת המובילים עבור שלב 8
    private void saveAndLoadLeaderboard() {
        ...
        // הבאת נתוני טבלת המובילים עבור שלב 8
    ...
    private void initViews() {
        ...
        BtClick21 = findViewById(R.id.BtClick21); // קישור הכפתור מה-XML
        BtClick21.setOnClickListener(this); // הגדרת מאזין ללחיצה
