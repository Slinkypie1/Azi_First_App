package com.example.asfirstapp; // החבילה שבה מוגדרת מחלקה זו

import android.content.Intent; // משמש לניווט בין אקטיביטיז (מסכים)
import android.os.Bundle; // מחזיק נתוני מצב שמורים עבור האקטיביטי
...
public class CorrectScreen3 extends BaseMenuActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_correct_screen3); // טעינת קובץ ה-XML של הפריסה
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            unlockNextLevel(3); // פתיחת השלב הבא אם יש צורך
    ...
    // שמירת זמן הסיום וטעינת טבלת המובילים עבור שלב 3
    private void saveAndLoadLeaderboard() {
        ...
        // הבאת נתוני טבלת המובילים עבור שלב 3
    ...
    private void initViews() {
        ...
        BtClick16 = findViewById(R.id.BtClick16); // קישור הכפתור מה-XML
        BtClick16.setOnClickListener(this); // הגדרת מאזין ללחיצה
