...
public class CorrectScreen5 extends BaseMenuActivity implements View.OnClickListener {
    ...
    Button BtClick18;
    // Button that moves the user to Level 6

    TextView leaderboardText;
    // TextView that displays the leaderboard

    long timeTaken;
    // Stores how long the user took to complete Level 5
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unlockNextLevel(5);
        // Marks Level 5 as completed and unlocks Level 6 if allowed

        saveAndLoadLeaderboard();
        // Saves the player's score and loads the leaderboard
    }

    // Saves the completion time and loads the leaderboard for Level 5
    private void saveAndLoadLeaderboard() {
        ...
        if (timeTaken > 0) {
            ...
            // Saves completion time for Level 5
        }

        // Requests leaderboard data for Level 5
        ProgressStorage.getLeaderboard(5, new ProgressStorage.LeaderboardCallback() {
    ...
    private void unlockNextLevel(int currentLevel) {
        ...
        if (currentLevel == ProgressStorage.getHighestUnlockedLevel(this)) {
            // Check if Level 5 was the latest unlocked level
    ...
    public void onClick(View view) {
        ...
        // Creates an intent to start the Level 6 puzzle activity
